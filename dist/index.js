...
/***/ function(module, exports, __webpack_require__) {
	...
	load = __webpack_require__(1);
	
	Q = __webpack_require__(2);
	
	module.exports = function(apiKey, version, sensor) {
	  var deferred, ref;
	  if (apiKey == null) {
	    apiKey = null;
	  }
	  ...
	  } else if (((ref = window.google) != null ? ref.maps : void 0) != null) {
	    console.log(google);
	    deferred.resolve(window.google);
	  } else {
	    if (window.__onGoogleLoaded == null) {
	      window.__onGoogleLoaded = function() {
	        return deferred.resolve(google);
	      };
	    }
	    load("https://maps.googleapis.com/maps/api/js?v=" + version + "&key=" + apiKey + "&sensor=" + (sensor ? 'true' : 'false') + "&callback=window.__onGoogleLoaded");
	  }
